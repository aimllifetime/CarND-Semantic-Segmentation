...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer4_vgg_resize = tf.layers.conv2d(vgg_layer4_out, num_classes, 1,
                                         padding= 'same',
                                         kernel_initializer = tf.random_normal_initializer(stddev=0.01),
                                         kernel_regularizer = tf.contrib.layers.l2_regularizer(1e-3))
    output = tf.add(output, layer4_vgg_resize)    # add the skip layer with vgg4 and upsample 2 of 1x1
    ...
    layer3_vgg_resize = tf.layers.conv2d(vgg_layer3_out, num_classes, 1,
                                         padding= 'same',
                                         kernel_initializer = tf.random_normal_initializer(stddev=0.01),
                                         kernel_regularizer = tf.contrib.layers.l2_regularizer(1e-3))
    output = tf.add(output, layer3_vgg_resize)    # add the skip layer with vgg3 and upsample 2 of first upsamepled layer
    ...
    # now upsample again on the output layer.
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    # how to penalize using the regularizer here?
